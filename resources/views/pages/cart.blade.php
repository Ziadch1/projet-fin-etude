  ...
  <div class="container">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td><img src="{{ asset('images/categories/pcgamer/' . $cart_product->img) }}" alt="" width="100" height="100"></td>
    ...
    <div class="row">
      <div class="col-md-6 offset-md-6">
        <h4>Total Price: <span id="total-price">{{ $total_price }}DH</span></h4>
        <h4>Number of Products in Cart: {{ count($cart_products) }}</h4>
      </div>
    </div>
